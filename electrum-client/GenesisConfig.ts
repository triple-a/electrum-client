...
export class GenesisConfig {
  ...
  static get GENESIS_HASH() {
    ...
    if (!GenesisConfig._config.GENESIS_HASH) {
      GenesisConfig._config.GENESIS_HASH = BitcoinJS.Block.fromHex(
        GenesisConfig._config.GENESIS_HEADER
      ).getId();
    }
  ...
  private static readonly CONFIGS: { [name in Network]: GenesisConfigConfig } =
    {
        ...
        SEED_PEERS: [
          {
            ...
            ports: { wss: null, ssl: 50002, tcp: 50001 },
            ip: "",
            version: "",
          },
          {
          ...
          {
            host: "btc.ultracloud.tk",
            ports: { wss: null, ssl: 50002, tcp: null },
            ip: "",
            version: "",
          },
          {
            host: "btc.electrum.bitbitnet.net",
            ports: { wss: null, ssl: 50002, tcp: 50001 },
            ip: "",
            version: "",
          },
          ...
          {
            host: "endthefed.onthewifi.com",
            ports: { wss: null, ssl: 50002, tcp: null },
            ip: "",
            version: "",
          },
          {
            host: "2ex.digitaleveryware.com",
            ports: { wss: null, ssl: 50002, tcp: null },
            ip: "",
            version: "",
          },
          {
            host: "1electrumx.hopto.me",
            ports: { wss: null, ssl: 50002, tcp: 50001 },
            ip: "",
            version: "",
          },
          ...
          {
            host: "electrum-btc.leblancnet.us",
            ports: { wss: null, ssl: 50002, tcp: 50001 },
            ip: "",
            version: "",
          },
          ...
          {
            host: "electrum.syngularity.es",
            ports: { wss: null, ssl: 50002, tcp: 50001 },
            ip: "",
            version: "",
          },
          {
            host: "electrum2.privateservers.network",
            ports: { wss: null, ssl: 50002, tcp: 50001 },
            ip: "",
            version: "",
          },
          {
            host: "electrum.snekash.io",
            ports: { wss: null, ssl: 50002, tcp: null },
            ip: "",
            version: "",
          },
          {
            host: "stavver.dyshek.org",
            ports: { wss: null, ssl: 50002, tcp: 50001 },
            ip: "",
            version: "",
          },
      ...
      testnet: {
        ...
        SEED_PEERS: [
          {
            host: "electrum.blockstream.info",
            ports: { wss: null, ssl: 60002, tcp: 60001 },
            ip: "",
            version: "",
          },
        ],
